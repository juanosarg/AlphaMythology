...
namespace MagicalAnimalRangeUnlocker
{
	...
	internal static class AnimalRangeAttack_Init
	{
		...
		{
			Harmony harmony = new Harmony("com.github.rimworld.mod.MagicalAnimalRangeAttack");
		...
		static bool Prefix(ref JobGiver_Manhunter __instance, ref Job __result, ref Pawn pawn)
		{
			...
			*/
			...
			if (shootable != null)
			{
				...
				__result = new Job(DefDatabase<JobDef>.GetNamed("MM_AnimalRangeAttack"), shootable, JobGiver_AIFightEnemy.ExpiryInterval_ShooterSucceeded.RandomInRange, true)
				{
					verbToUse = rangeVerb
				};
	...
	static class ARA_FightAI_Patch
	{
		static bool Prefix(ref JobGiver_AIFightEnemy __instance, ref Job __result, ref Pawn pawn)
		{
			...
			if (flag1 && flag2 && flag3 || flag4 && flag3)
			{
				...
				__result = new Job(DefDatabase<JobDef>.GetNamed("MM_AnimalRangeAttack"), enemyTarget, JobGiver_AIFightEnemy.ExpiryInterval_ShooterSucceeded.RandomInRange, true)
				{
					verbToUse = rangeVerb
